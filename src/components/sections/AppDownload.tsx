      ...
      <div className="max-w-[1530px] mx-auto px-5 flex items-center justify-between flex-wrap max-md:gap-12">
        ...
        <div className="self-stretch flex min-w-60 flex-col items-stretch justify-center flex-1 shrink basis-[0%] my-auto max-md:max-w-full">
          ...
          <div className="flex w-full flex-col justify-center mt-8 max-md:max-w-full">
            ...
            <div 
              className="flex gap-[30px] text-black mt-6 max-md:flex-col max-md:gap-4 max-md:items-center"
              data-aos="fade-left"
              data-aos-delay="400"
            >
              <button className="bg-white border-2 border-[rgba(217,37,70,1)] flex items-stretch gap-[9px] overflow-hidden text-[13px] font-normal uppercase px-[11px] py-2 rounded-lg transition-all duration-300 hover:scale-105 hover:border-[rgba(217,37,70,1)] hover:shadow-lg" style={{ width: 'fit-content' }}>
                <img
              ...
              <button className="bg-white border-2 border-[rgba(217,37,70,1)] flex items-stretch gap-2.5 overflow-hidden font-medium leading-none px-[9px] py-2.5 rounded-lg transition-all duration-300 hover:scale-105 hover:border-[rgba(217,37,70,1)] hover:shadow-lg" style={{ width: 'fit-content' }}>
                <img
            ...
            <button 
              className="bg-[rgba(217,37,70,1)] flex items-center justify-center text-white gap-2.5 mt-6 px-4 py-3 rounded-[58px] transition-all duration-300 hover:scale-105 hover:bg-white hover:text-[rgba(217,37,70,1)] hover:border-2 hover:border-[rgba(217,37,70,1)] hover:shadow-lg max-md:mx-auto" 
