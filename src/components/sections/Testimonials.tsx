...
export const Testimonials = () => {
  ...
  return (
    <section className="bg-[rgba(242,242,242,1)] w-full overflow-hidden mt-[120px] py-20 max-md:mt-10">
      <div className="max-w-[1530px] mx-auto px-5">
        <div className="flex items-center justify-between gap-[30px] flex-wrap max-md:flex-col">
          ...
          <div className="min-w-60 w-[765px] max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-[rgba(191,42,55,0.2)] flex flex-1 flex-col items-stretch text-base font-normal justify-center px-[17px] py-6 rounded-2xl">
