...
export const ProjectGallerySection = ({ galleryImages, projectTitle }: ProjectGallerySectionProps) => {
                  ...
                  <button
                    ...
                    className={`aspect-square rounded-lg overflow-hidden transition-all ${
                      selectedImageIndex === actualIndex 
                        ? 'ring-2 ring-[rgba(217,37,70,1)] ring-offset-2' 
                        : 'hover:opacity-80'
                    }`}
                  >
                    <img 
                      src={image} 
                      alt={`${projectTitle} - Thumbnail ${actualIndex + 1}`}
                      className="w-full h-full object-cover"
                    />
                  </button>
                );
