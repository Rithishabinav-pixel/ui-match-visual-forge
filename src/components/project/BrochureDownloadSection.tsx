          ...
          <div className="order-1 lg:order-2">
            <div className="max-w-md">
              <h2 className="text-4xl font-bold text-[rgba(40,45,64,1)] mb-6 max-md:text-3xl">
                Download JKB Grace Brochure
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                {brochureSection?.description || "Download our comprehensive project brochure for complete details about JKB Grace, including floor plans, amenities, specifications, location insights, and pricing information. Get all the information you need to make an informed decision about your dream home."}
              </p>
