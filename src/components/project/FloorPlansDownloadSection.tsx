...
export const FloorPlansDownloadSection = ({
  ...
  const defaultPlans: FloorPlan[] = [
    ...
    {
      title: "2nd Floor - 3BHK (East Facing)", 
      image: "/lovable-uploads/3cbfa16f-b4dc-4ac3-86c3-f92f189294c1.png",
      description: "Premium 3BHK layout with eastern exposure and enhanced living space",
      area: "1500 sq.ft",
      bedrooms: "3"
    },
    {
      title: "3rd Floor - 2.5BHK (North Facing)",
      image: "/lovable-uploads/3cbfa16f-b4dc-4ac3-86c3-f92f189294c1.png", 
      description: "Unique 2.5BHK layout with northern exposure and optimized space",
      area: "1350 sq.ft",
      bedrooms: "2.5"
    }
  ];
      ...
      <div className="max-w-[1200px] mx-auto px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white mb-6 max-md:text-3xl">
            Explore Our <span className="text-[rgba(217,37,70,1)]">Thoughtfully Designed Floor Plans</span>
          </h2>
          <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Each floor plan at JKB Grace is meticulously crafted to maximize space utilization while ensuring optimal natural light and ventilation. Download detailed layouts to visualize your future home and make an informed decision.
          </p>
        </div>
